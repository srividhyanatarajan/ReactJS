          ...
          <tbody>
            <tr>
              ...
              <td className="col-lg-4">
                ...
                {this.state.status?<Modalwindow1 a={this.props.efrom} b={this.props.esubject} c={this.props.edate} d={this.props.encodedBodyToChild} changeviewstatus={this.viewChange}/>:null}
              </td>
