...
var GmailBox = React.createClass({
 getInitialState: function()
   {
     return({allLabelsData:[],allMessagesData:[],allInboxData:[],completeMessageData:[]});
   },
 gmailLogin: function()
 {
 ...
 allLabels: function()
 {
    ...
    getEmailByLabel : function(labelId){
     ...
     $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/sr.vidhya1%40gmail.com/messages?includeSpamTrash=false&labelIds='+labelId+'&maxResults=5&key={AIzaSyAJrdDygyaqs7n7Q625-cvOEmtY2lpHvUk}',
      dataType: 'json',
      type: 'GET',
      beforeSend: function (request)
      {
      ...
      success: function(data)
      {
        ...
        this.setState({completeMessageData:messarray});
        loadedData=true;
      }.bind(this),
      error: function(xhr, status, err) {
        console.error(err.toString());
   ...
   getEmailByLabelIDMessage : function(id,accessTokenId){
     var arrdata = $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/sr.vidhya1%40gmail.com/messages/'+id+'?key={AIzaSyAJrdDygyaqs7n7Q625-cvOEmtY2lpHvUk}',
      dataType: 'json',
      type: 'GET',
      async: false,
      beforeSend: function (request)
    ...
    render:function()
 {
   ...
   var rightPanel;
     ...
     rightPanel = <RightPanelComponent completeMessageData={this.state.completeMessageData} />
